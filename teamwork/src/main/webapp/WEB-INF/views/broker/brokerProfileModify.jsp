            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="cf-content">
                       ...
                       <form action="/broker/brokerProfileModify" method="post" class="cc-form" id="usercheck" name="member" role="form">

                            <div class="mx-auto" style="width: 200px;">
                            
                            	<div id="divInputId" >
                            	<label >아이디</label>
                            	<input autocomplete="off" type="hidden"  value="${logionbroker.mno }" name="mno" id="mno" class="inputcss" readonly>
                                <input autocomplete="off" type="hidden"  value="${logionbroker.mid }" name="mid" id="mid" class="inputcss" readonly>
                                <input autocomplete="off" type="text"  value="${logionbroker.mid }"  id="mid" class="inputcss" disabled>
                                <div  id="id_check"></div>
                               ...
                               <div>
                               <label >이메일</label>
                                <input autocomplete="off" type="text" value="${logionbroker.email }" name="email" id="email" class="inputcss" disabled>
                                <div class="eheck_font" id="email_check"></div>
                                </div>
                               <div> 
                               <label >주민등록번호 앞자리</label>
                               <input autocomplete="off" type="text" value="${logionbroker.birthday }" name="birthday" id="birthday" class="inputcss" disabled>
                               <div class="eheck_font" id="birthday_check"></div>
                               </div>
                               
                               <div>
                               <label >휴대폰 번호</label>
                                <input autocomplete="off" type="text" value="${logionbroker.phone }" name="phone" id="phone" class="inputcss"> 
                                <div class="eheck_font" id="phone_check"></div>
                                 ...
                                 <div>
                               <label >사업자 번호</label>
                                <input autocomplete="off" type="text" value="${logionbroker.corporate }" name="corporate" id="corporate" class="inputcss" disabled>
                                <div class="eheck_font" id="corporate_check"></div>
                                </div>
                                
                                <div>
                               <label >사업장 명</label>
                                <input autocomplete="off" type="text" value="${logionbroker.corporateName}" name="corporateName" id="corporateName" class="inputcss" required>
                                <div class="eheck_font" id="phone_check"></div>
                                </div>
                                
                                <div>
                               <label >사업장 주소</label> 
                               <input type="text" id="sample4_roadAddress"  value="${logionbroker.corporateAddress}" name="corporateAddress"  class="corporateAddresscss" required readonly>
							   ...
							   <span id="guide" style="color:#999;display:none"></span>
                                ...
                                <div>
                               <label >사업자 대표</label>
                                <input autocomplete="off" type="text" value="${logionbroker.corporateCeo }" name="corporateCeo" id="corporateCeo" class="inputcss" disabled>
